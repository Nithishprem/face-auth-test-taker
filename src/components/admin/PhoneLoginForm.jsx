...
function PhoneLoginForm({ number, setNumber, handleNext }) {
  ...
  //     let errMsg = error?.response?.data?.detail[0]?.msg;
  //     if (errMsg && typeof errMsg) {
  //       setError(errMsg);
      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            <h1 className="text-lg font-medium leading-tight tracking-tight text-gray-900">Log in to your account</h1>
